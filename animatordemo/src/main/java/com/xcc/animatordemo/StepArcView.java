...
public class StepArcView extends View {
    ...
    //2.绘制当前步数的红色圆弧
    private void drawAcrRed(Canvas canvas,RectF rectF){
    ...
    private void drawTextNumber(Canvas canvas,float centerX){
       Paint vTextPaint=new Paint();
        ...
        vTextPaint.getTextBounds(stepNunber,0,stepNunber.length(),bounds_Number);
        canvas.drawText(stepNunber,centerX,getHeight()/2+bounds_Number.height()/2,vTextPaint);
    }
    ...
    private int getFontHeight(float fontSize) {
        ...
        Rect bounds_Bumber=new Rect();
        paint.getTextBounds(stepNunber,0,stepNunber.length(),bounds_Bumber);
        return bounds_Bumber.height();
    }
