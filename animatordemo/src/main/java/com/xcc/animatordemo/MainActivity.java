    ...
    public void onClick(View v){
        ...
        switch (v.getId()){
            ...
            case R.id.animation_group1://先播放缩放动画，完成后播放旋转动画
                //动画组合
                AnimatorSet animationSetGroup1=new AnimatorSet();
                ...
                animationSetGroup1.setDuration(1000);
                animationSetGroup1.play(objectAnimatorScaleX1)
                                  .with(objectAnimatorScaleY1)
                                  .before(objectAnimatorRotateX1)
                                  .before(objectAnimatorRotateY1);
               animationSetGroup1.start();
                break;
